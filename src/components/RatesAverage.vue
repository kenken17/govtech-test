<template>
    <div class="rate-average md-layout" v-show="ratesAverages.length > 0">
        <md-table md-card v-model="ratesAverages" class="md-layout-item">
            <md-table-toolbar>
                <h1 class="md-title">Rates Average (% p.a.)</h1>
                <span class="md-caption"><strong>FD</strong> = Fixed Deposits <strong>SD</strong> = Saving Deposits </span>
            </md-table-toolbar>
...
export default {
    ...
    computed: {
        ...mapGetters('rateModule', {
            ratesAverages: 'getRatesAverages',
