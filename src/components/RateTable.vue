<template>
    <div class="rate-table md-layout" v-show="ratesRecords.length > 0">
        <md-table md-card v-model="ratesRecords" class="md-layout-item">
            <md-table-toolbar>
                <h1 class="md-title">Rates Result (% p.a.)</h1>
